# Legacy file: Faerun lore constants extracted from ItemEngine.
# Used only by the seed migration for generating item names and descriptions.
# Do not add new constants here — this module exists for backward compatibility.
