puts "Seeding Lore Entries..."
# ═══════════════════════════════════════════════
# PART 1: Generic proper names (faerun + middle_earth)
# ═══════════════════════════════════════════════
puts "  Seeding generic proper names..."
    proper_names = {
      "faerun" => %w[
...
puts "  Generic proper names created: #{created}"

# ═══════════════════════════════════════════════
# PART 2: Origin-specific proper names (elfico, enano, humano, divino)
# ═══════════════════════════════════════════════
puts "  Seeding origin proper names..."
...
puts "  Origin proper names created: #{created}"
puts "Lore Entries total: #{LoreEntry.count}"
